<template>
  <div>
    ...
    <button type="button" @click="onClickSaveImageFileInMutliMode">
      Save Image File (Multi)
    </button>
    <div>
      <simple-image-editor
        ref="multiCanvas"
        ...
        :cropWidth="200"
        :cropHeight="200"
        :resizeHandlerStyle="{ strokeColor: '#000000' }"
        @changeImage="onChangeImage"
      />
    </div>
    <br />
    <div>Resize &amp; Crop Mode (Fix)</div>
    <button type="button" @click="onClickSaveImageFileInMutliModeWithFixedCrop">
      Save Image File (Multi)
    </button>
    <div>
      <simple-image-editor
        ref="multiCanvasWithFixedCrop"
        style="border: 1px solid red;"
        :width="800"
        :height="600"
        :imageSrc="imageSrc"
    ...
    <br />
    <div>Resize Mode</div>
    <button type="button" @click="onClickSaveImageFileInResizeMode">
      Save Image File (Resize)
    </button>
    <div>
      <simple-image-editor
        ref="resizeCanvas"
    ...
    <br />
    <div>Crop Mode</div>
    <button type="button" @click="onClickSaveImageFileInCropMode">
      Save Image File (Crop)
    </button>
    ...
    <button type="button" @click="onClickSaveImageFileInCropModeWithFixedCrop">
      Save Image File (Crop)
    </button>
    <button type="button" @click="onClickSaveCropWithFixedCrop">
      Save Crop
    </button>
    <div>
      <simple-image-editor
        ref="cropCanvasWithFixedCrop"
        style="border: 1px solid red;"
        :width="800"
        :height="600"
        :imageSrc="imageSrc"
